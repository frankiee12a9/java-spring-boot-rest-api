...
public class Random {
    ...
    public static String token(Long id, String username, String email, LocalDateTime expiration, String secret, List<String> roles) {
      var token = JWT.encode(id, username, email, roles, expiration, secret);
      return format("Bearer %s", token);
    }
