package com.github.frankiie.springboot.domain.session.repository;

import static com.github.frankiie.springboot.domain.session.repository.Queries.DISABLE_OLD_REFRESH_TOKENS_FROM_USER;
import static com.github.frankiie.springboot.domain.session.repository.Queries.FIND_REFRESH_TOKEN_BY_CODE_FETCH_USER_AND_ROLES;
