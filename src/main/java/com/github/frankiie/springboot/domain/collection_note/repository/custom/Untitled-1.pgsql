...
select n.id, n.note_title, n.note_link from note n;
select n.id, n.used_at from note n where n.id = 23;
select n.id, n.used_at from note n where n.created_at is not null;
