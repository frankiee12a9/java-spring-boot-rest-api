...
public class UsersController {
    ...
    public ResponseEntity<Page<UserResponse>> index(
        ...
        Optional<Integer> size 
    			// @RequestParam(value = "page", required = false, defaultValue = DEFAULT_PAGE_NUMBER) Optional<Integer> page,
    			// @RequestParam(value = "size", required = false, defaultValue = DEFAULT_PAGE_SIZE) Optional<Integer> size
    )  {
