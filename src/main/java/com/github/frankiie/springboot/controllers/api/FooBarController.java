...
import com.github.frankiie.springboot.domain.test_foo_bar.Bar;
import com.github.frankiie.springboot.domain.test_foo_bar.CreateBar;
import com.github.frankiie.springboot.domain.test_foo_bar.CreateFoo;
import com.github.frankiie.springboot.domain.test_foo_bar.Foo;
import com.github.frankiie.springboot.domain.test_foo_bar.FooBarService;
...
public class FooBarController {
    ...
    @Operation(summary = "")
    public ResponseEntity<Foo> getOneFoo(@PathVariable Long id) {
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN', 'USER')")
    @Operation(summary = "")
    public ResponseEntity<Bar> getOneBar(@PathVariable Long id) {
